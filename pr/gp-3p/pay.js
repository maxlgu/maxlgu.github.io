...
(function() {
    ...
    */
    ...
    u("Promise", function(a) {
        ...
        e.prototype.then = function(f, h) {
            function k(y, I) {
                return "function" == typeof y ? function(ja) {
                    try {
                        l(y(ja))
                    } catch (T) {
                        q(T)
        ...
        e.all = function(f) {
            ...
            return k.done ? c([]) : new e(function(l, q) {
                ...
                var y = [],
                    I = 0;
                do y.push(void 0), I++, c(k.value).Sa(x(y.length -
    ...
    */
    ...
    gb[" "] = na;
    var hb = F(G, "Trident") || F(G, "MSIE"),
        ib = F(G, "Gecko") && !(F(G.toLowerCase(), "webkit") && !F(G, "Edge")) && !(F(G, "Trident") || F(G, "MSIE")) && !F(G, "Edge"),
        jb = F(G.toLowerCase(), "webkit") && !F(G, "Edge");
    ...
    var rb = function(a) {
            if (a instanceof qb && a.constructor === qb) return a.sb;
        ...
        tb = /%{(\w+)}/g,
        sb = RegExp("^((https:)?//[0-9a-z.:[\\]-]+/|/[^/\\\\]|[^:/\\\\%]+/|[^:/\\\\%]*[?#]|about:blank#)", "i"),
        pb = {},
        ub = function(a) {
            var b = ob();
    ...
    var yb = function(a) {
            if (a instanceof xb && a.constructor === xb) return a.rb;
    ...
    var Bb = function(a) {
        ...
        Fb = function(a) {
            var b = Db(Eb),
                ...
                d = [],
                e = function(g) {
                    Array.isArray(g) ? g.forEach(e) : (g = Db(g), d.push(Bb(g).toString()), g = g.ya(), 0 == c ? c = g : 0 != g && c != g && (c = null))
                };
            a.forEach(e);
            return Cb(d.join(Bb(b).toString()), c)
        },
        Gb = function(a) {
        ...
        Eb = new H(w.trustedTypes && w.trustedTypes.emptyHTML || "", 0, Ab),
        Hb =
        Cb("<br>", 0);
    var Ib = {
            MATH: !0,
        ...
        Kb = function(a, b) {
            if (a.tagName && Ib[a.tagName.toUpperCase()]) throw Error("goog.dom.safe.setInnerHtml cannot be used to set content of " +
                a.tagName + ".");
            if (Jb())
        ...
        Lb = function(a, b, c, d) {
            a instanceof xb || a instanceof xb || (a = "object" == typeof a && a.Ca ? a.za() : String(a), A(zb.test(a), "%s does not match the safe URL pattern", a) || (a = "about:invalid#zClosurez"), a = new xb(a, wb));
            b = b || w;
            c = c instanceof B ? C(c) : c || "";
            return void 0 !== d ? b.open(yb(a), c, d) : b.open(yb(a), c)
        };
    var Mb = function() {
    ...
    var Ob = function(a) {
        ...
        d = c.createElement(d);
        hb ? (Kb(d, Gb(Hb, b)), d.removeChild(A(d.firstChild))) : Kb(d, b);
    ...
    var Pb = function(a) {
        ...
        Rb = function(a, b, c) {
            if (a.forEach && "function" == typeof a.forEach) a.forEach(b, c);
                ...
                for (var d = Qb(a), e = Pb(a), g = e.length, f = 0; f < g; f++) b.call(c, e[f], d && d[f], a)
        };
    var Sb = RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$"),
        Tb = function(a) {
            var b = a.match(Sb);
            a = b[1];
            var c = b[3];
    ...
    var J = function(a) {
        ...
        if (a instanceof J) {
            ...
            K(this);
            this.M = a
        } else a && (b = String(a).match(Sb)) ? (this.G = !1, Vb(this, b[1] || "", !0), a = b[2] || "", K(this), this.ma = Yb(a), a = b[3] || "", K(this), this.P = Yb(a, !0), Wb(this, b[4]), a = b[5] || "", K(this), this.N = Yb(a, !0), Xb(this, b[6] || "", !0), a = b[7] || "", K(this), this.M = Yb(a)) :
            (this.G = !1, this.I = new L(null, this.G))
    };
    J.prototype.toString = function() {
        ...
        b && a.push(Zb(b, $b, !0), ":");
        var c = this.P;
        if (c || "file" == b) a.push("//"), (b = this.ma) && a.push(Zb(b, $b, !0), "@"), a.push(encodeURIComponent(String(c)).replace(/%25([0-9a-fA-F]{2})/g, "%$1")), c = this.j, null != c && a.push(":", String(c));
        if (c = this.N) this.P && "/" != c.charAt(0) && a.push("/"), a.push(Zb(c, "/" == c.charAt(0) ? ac : bc, !0));
        (c = this.I.toString()) && a.push("?", c);
        (c = this.M) && a.push("#", Zb(c, cc));
        return a.join("")
    };
        ...
        if (c) Wb(b, a.j);
            ...
            if (".." == e || "." == e) d = "";
                ...
                for (var g = [], f = 0; f < e.length;) {
                    var h = e[f++];
                    "." == h ? d && f == e.length && g.push("") : ".." == h ? ((1 < g.length ||
                        1 == g.length && "" != g[0]) && g.pop(), d && f == e.length && g.push("")) : (g.push(h), d = !0)
                }
                d = g.join("/")
            } else d = e
        }
        c ? (K(b), b.N = d) : c = "" !== a.I.toString();
        c ? Xb(b, a.I.clone()) : c = !!a.M;
        c && (a = a.M, K(b), b.M = a);
        return b
    };
    ...
    var Vb = function(a, b, c) {
        ...
        Xb = function(a, b, c) {
            K(a);
            b instanceof L ? (a.I = b, a.I.xb(a.G)) : (c || (b = Zb(b, dc)), a.I = new L(b, a.G))
        };
    ...
    var Yb = function(a, b) {
        ...
        M = function(a) {
            a.h || (a.h = new r.Map, a.A = 0, a.D && Ub(a.D, function(b, c) {
    ...
    m.ia = function(a) {
        M(this);
        var b = [];
        if ("string" === typeof a) hc(this, a) && (b = b.concat(this.h.get(gc(this, a))));
        else {
    ...
    m.set = function(a, b) {
        ...
        this.D = null;
        a = gc(this, a);
        hc(this, a) && (this.A = za(this.A) - this.h.get(a).length);
        this.h.set(a, [b]);
        this.A = za(this.A) + 1;
        return this
    };
    ...
    L.prototype.xb = function(a) {
        a && !this.G && (M(this), this.D = null, this.h.forEach(function(b, c) {
            var d = c.toLowerCase();
    ...
    L.prototype.extend = function(a) {
        for (var b = 0; b < arguments.length; b++) Rb(arguments[b], function(c, d) {
            this.add(d, c)
        }, this)
    };
    var ic = [],
        jc = [],
        kc = [],
        lc = window.location.hostname,
        mc = window.whitelistedDomainsHashedValueListForGpayButtonWithCardInfo || [],
        nc = window.denylistedDomainsHashedValueListForGpayButtonWithCardInfo || [],
        oc = window.denylistedMerchentIdsHashedValueListForGpayButtonWithCardInfo || [];

    function pc(a) {
        t(kc, "includes").call(kc, a.buttonRootNode || document) || (Ra("\n  .gpay-card-info-container {\n    padding: 0;\n    position: relative;\n    min-width: 240px;\n    height: 40px;\n    min-height: 40px;\n    border-radius: 4px;\n    box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 1px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px;\n    cursor: pointer;\n    border: 0px;\n  }\n\n  .gpay-card-info-container.black,\n  .gpay-card-info-animation-container.black {\n    background-color: #000;\n    box-shadow: none;\n  }\n\n  .gpay-card-info-container.white,\n  .gpay-card-info-animation-container.white {\n    background-color: #fff;\n  }\n\n  .gpay-card-info-container.black.active {\n    background-color: #5f6368;\n  }\n\n  .gpay-card-info-container.black.hover,\n  .gpay-card-info-animation-container.black.hover {\n    background-color: #3c4043;\n  }\n\n  .gpay-card-info-container.white.active {\n    background-color: #fff;\n  }\n\n  .gpay-card-info-container.white.focus {\n    box-shadow: #e8e8e8 0 1px 1px 0, #e8e8e8 0 1px 3px;\n  }\n\n  .gpay-card-info-container.white.hover,\n  .gpay-card-info-animation-container.white.hover {\n    background-color: #f8f8f8;\n  }\n\n  .gpay-card-info-iframe {\n    border: 0;\n    display: block;\n    height: 40px;\n    margin: auto;\n    max-width: 100%;\n    width: 240px;\n  }\n\n  .gpay-card-info-container-fill .gpay-card-info-iframe{\n    position: absolute;\n    top: 0;\n    height: 100%;\n    width: 100%;\n  }\n\n  .gpay-card-info-container-fill,\n    .gpay-card-info-container-fill > .gpay-card-info-container{\n    width: 100%;\n    height: inherit;\n  }\n\n  .gpay-card-info-container-fill .gpay-card-info-placeholder-container{\n    align-items: center;\n    justify-content: center;\n    width: 100%;\n    padding-top: 3px;\n    box-sizing: border-box;\n    overflow: hidden;\n  }\n\n  .gpay-card-info-container-fill .gpay-card-info-placeholder-svg-container{\n    position: relative;\n    width: 60%;\n    height: inherit;\n    max-height: 80%;\n    margin-right: -20%;\n  }\n\n  .gpay-card-info-container-fill .gpay-card-info-placeholder-svg-container > svg {\n    position: absolute;\n    left: 0;\n    height: 100%;\n    max-width: 100%;\n  }\n", a.buttonRootNode),
            Ra('\n  .gpay-card-info-animation-container {\n    display: flex;\n    width:100%;\n    position: absolute;\n    z-index: 100;\n    height: 40px;\n    border-radius: 4px;\n  }\n\n  .gpay-card-info-placeholder-container {\n    display: flex;\n    width: 240px;\n    height: 100%;\n    margin: auto;\n  }\n\n  .gpay-card-info-animated-progress-bar-container {\n    display: flex;\n    box-sizing: border-box;\n    position: absolute;\n    width: 100%;\n  }\n\n  .gpay-card-info-animated-progress-bar {\n    border-radius: 4px 4px 0px 0px;\n    animation-duration: 0.5s;\n    animation-fill-mode: forwards;\n    animation-iteration-count: 1;\n    animation-name: gpayProgressFill;\n    animation-timing-function: cubic-bezier(0.97, 0.33, 1, 1);\n    background: #caccce;\n    width: 100%;\n    height: 3px;\n    max-height: 3px;\n  }\n\n  .gpay-card-info-animated-progress-bar-indicator {\n    border-radius: 4px 4px 0px 0px;\n    max-width: 20px;\n    min-width: 20px;\n    height: 3px;\n    max-height: 3px;\n    background: linear-gradient(to right, #caccce 30%, #acaeaf 60%);\n    animation-delay: 0.5s;\n    animation-duration: 1.7s;\n    animation-fill-mode: forwards;\n    animation-iteration-count: infinite;\n    animation-name: gpayPlaceHolderShimmer;\n  }\n\n  .gpay-card-info-iframe-fade-in {\n    animation-fill-mode: forwards;\n    animation-duration: 0.6s;\n    animation-name: gpayIframeFadeIn;\n  }\n\n  .gpay-card-info-animation-container-fade-out {\n    animation-fill-mode: forwards;\n    animation-duration: 0.6s;\n    animation-name: gpayPlaceHolderFadeOut;\n  }\n\n  .gpay-card-info-animation-gpay-logo {\n    margin: 13px 7px 0px  39px;\n    background-origin: content-box;\n    background-position: center center;\n    background-repeat: no-repeat;\n    background-size: contain;\n    height: 17px;\n    max-height: 17px;\n    max-width: 41px;\n    min-width: 41px;\n  }\n\n  .gpay-card-info-animation-gpay-logo.black {\n    background-image: url("https://www.gstatic.com/instantbuy/svg/dark_gpay.svg");\n  }\n\n  .gpay-card-info-animation-gpay-logo.white {\n    background-image: url("https://www.gstatic.com/instantbuy/svg/light_gpay.svg");\n  }\n\n  @keyframes gpayPlaceHolderShimmer{\n    0% {\n      margin-left: 0px;\n    }\n    100% {\n      margin-left: calc(100% - 20px);\n    }\n  }\n\n  @keyframes gpayIframeFadeIn {\n    from {\n        opacity: 0;\n    }\n    to {\n        opacity: 1;\n    }\n  }\n\n  @keyframes gpayPlaceHolderFadeOut {\n    from {\n        opacity: 1;\n    }\n\n    to {\n        opacity: 0;\n    }\n  }\n\n  @keyframes gpayProgressFill {\n    from {\n      width: 0;\n    }\n    to {\n      width: 100%;\n    }\n  }\n\n  .gpay-card-info-container-fill .gpay-card-info-animation-container{\n    top: 0;\n    width: 100%;\n    height: 100%;\n  }\n\n  .gpay-card-info-container-fill .gpay-card-info-animation-gpay-logo{\n    background-position: right;\n    margin: 0 0 0 0;\n    max-width: none;\n    width: 25%;\n    height:inherit;\n    max-height: 50%;\n  }\n',
                a.buttonRootNode), kc.push(a.buttonRootNode || document));
        var b = qc(a),
            c = "white" == a.buttonColor ? "white" : "black",
            d = document.createElement("button");
        rc(d);
        d.setAttribute("class", (-1658203989 === Wa(lc) ? "gpay-button" : "") + " gpay-card-info-container " + b);
        ...
        g.setAttribute("class", "gpay-card-info-animation-gpay-logo " +
            c);
        var f = Ob("white" == a.buttonColor ? Na : Oa);
        ...
        h.appendChild(k);
        b.appendChild(g);
        "fill" !== a.buttonSizeMode ? b.appendChild(f) : (g = Ob("white" == a.buttonColor ? Pa : Qa), f = document.createElement("div"), f.appendChild(g),
        ...
        ec(b, "buttonColor", a.buttonColor);
        ec(b, "browserLocale", tc(a.buttonLocale));
        ec(b, "buttonSizeMode", a.buttonSizeMode);
        void 0 !== a.allowedPaymentMethods && ec(b, "allowedPaymentMethods",
    ...
    uc.prototype.postMessage = function(a, b) {
    ...
    */
    ...
    var wc = {
        ...
        Bc = [],
        Dc = function() {
            Cc({}, 11, ["canMakePaymentForPaymentHandlerResponse"], function() {})
        },
        Cc = function(a, b, c, d) {
            function e(g) {
                var f;
        ...
        Q = function(a) {
            if (Ac && xc) {
                a = t(Object, "assign").call(Object, {
                    buyFlowActivityMode: P,
                    googleTransactionId: yc,
                    originTimeMs: zc
                }, a);
    ...
    var Jc = function(a, b, c, d) {
            return r.Promise.resolve(r.Promise.race([Gc("PAYMENT_AUTHORIZATION", c), b.onPaymentAuthorized(a)])).then(function(e) {
                return d("paymentAuthorizationResponse", e)
            }, function(e) {
                Ic("REQUEST_TIMEOUT" === e.message, 27, 2);
                return d("paymentAuthorizationResponse", Hc(e, "PAYMENT_AUTHORIZATION"))
            })
        },
        Kc = function(a, b, c, d) {
            return r.Promise.resolve(r.Promise.race([Gc(a.callbackTrigger in Ea ? Ea[a.callbackTrigger] : "UNKNOWN_INTENT", c), b.onPaymentDataChanged(a)])).then(function(e) {
                return d("paymentDataCallbackResponse",
                    e)
            }, function(e) {
                Ic("REQUEST_TIMEOUT" === e.message, 26, wc[a.callbackTrigger]);
                return d("paymentDataCallbackResponse", Hc(e, a.callbackTrigger || "UNKNOWN_INTENT"))
            })
        };
    var Mc = function() {
    ...
    function Nc(a, b) {
        ...
        return (new r.Promise(function(e) {
            c.setTimeout(function() {
                c.setTimeout(e, 300);
                Lc(a, t(Object, "assign").call(Object, {
    ...
    m.O = function(a) {
        Qc(a, this.s, a.transactionInfo.currencyCode, a.transactionInfo.totalPrice)
    };
    m.U = function(a) {
        Rc(this, a)
    };
    var Qc = function(a, b, c, d) {
        ...
        Rc = function(a, b) {
            b = Qc(b, a.s, b.transactionInfo && b.transactionInfo.currencyCode || void 0, b.transactionInfo && b.transactionInfo.totalPrice || void 0);
            b.onpaymentmethodchange =
                function(c) {
                    var d = new Fc;
                    d = c.methodDetails.callbackTrigger ? Kc(c.methodDetails, a.B, a.la, d.Qb) : Jc(c.methodDetails, a.B, a.la, d.Qb);
                    c.updateWith(d)
                };
    ...
    var Sc = ["SHIPPING_ADDRESS", "SHIPPING_OPTION"];
    ...
    function Vc(a, b) {
        return 2 <= a.apiVersion && (a = Uc(a)) && t(a, "includes").call(a, b) ? !0 : !1
    }
    ...
    function Yc(a) {
        ...
        if (Zc(a)) return "UPI not supported";
        if (2 <= a.apiVersion) {
            ...
            for (var b = 0; b < a.allowedPaymentMethods.length; b++) {
                ...
                if ("CARD" == c.type) {
                    ...
                    if (!c || !Array.isArray(c) || 0 == c.length || !c.every($c)) return "allowedAuthMethods must be setup in parameters for type 'CARD'  and must contain 'CRYPTOGRAM_3DS' and/or 'PAN_ONLY'"
                }
            }
        } else if (!a.allowedPaymentMethods || !Array.isArray(a.allowedPaymentMethods) || 0 == a.allowedPaymentMethods.length || !a.allowedPaymentMethods.every(ad)) return "allowedPaymentMethods must be set to an array containing 'CARD' and/or 'TOKENIZED_CARD'!";
        return null
    }
    ...
    function Zc(a) {
        return 2 > a.apiVersion || !a.allowedPaymentMethods ? null : cd(a, "UPI")
    }
    ...
    var fd = function(a, b) {
            ...
            if (!c) {
                var d = Mb();
                c = d;
                void 0 === a.style[d] && (d = (jb ? "Webkit" : ib ? "Moz" : hb ? "ms" : null) + Nb(d), void 0 !== a.style[d] && (c = d));
                ed.transition = c
            }
            c && (a.style[c] = b)
        },
    ...
    var S = function(a, b) {
        ...
        if (a) {
            ...
            d ? (this.clientX = void 0 !== d.clientX ? d.clientX : d.pageX, this.clientY = void 0 !== d.clientY ? d.clientY : d.pageY, this.screenX = d.screenX || 0, this.screenY = d.screenY || 0) : (this.offsetX = jb || void 0 !== a.offsetX ? a.offsetX : a.layerX, this.offsetY = jb || void 0 !== a.offsetY ? a.offsetY : a.layerY, this.clientX = void 0 !== a.clientX ? a.clientX : a.pageX,
            ...
            this.state = a.state;
            this.xa = a;
            a.defaultPrevented && S.Ka.preventDefault.call(this)
        }
    };
    ta(S, R);
    var kd = id({
    ...
    pd.prototype.add = function(a, b, c, d, e) {
        ...
        var f = qd(a, b, d, e); - 1 < f ? (b = a[f], c || (b.Ra = !1)) : (b = new nd(b, this.src, g, !!d, e), b.Ra = c, a.push(b));
        return b
    };
    pd.prototype.remove = function(a, b, c, d) {
        ...
        var e = this.v[a];
        b = qd(e, b, c, d);
        return -1 < b ? (od(e[b]), A(null != e.length), Array.prototype.splice.call(e, b, 1), 0 == e.length && (delete this.v[a], this.Na--), !0) : !1
    };
    var rd = function(a, b) {
        var c = b.type;
        if (c in a.v) {
            ...
            g && (od(b), 0 == a.v[c].length && (delete a.v[c], a.Na--))
        }
    };
    pd.prototype.ib = function(a, b, c, d) {
        a = this.v[a.toString()];
        var e = -1;
        a && (e = qd(a, b, c, d));
        return -1 < e ? a[e] : null
    ...
    var sd = "closure_lm_" + (1E6 * Math.random() | 0),
        ...
        wd = function(a, b, c, d, e) {
            if (d && d.once) vd(a, b, c, d, e);
                ...
                for (var g = 0; g < b.length; g++) wd(a, b[g], c, d, e);
            else c = xd(c), a && a[ld] ? (d = pa(d) ? !!d.capture : !!d, yd(a), a.K.add(String(b), c, !1, d, e)) : zd(a, b, c, !1, d, e)
        },
        zd = function(a, b, c, d, e, g) {
            ...
            if (!c.proxy) {
                ...
                d.src = a;
                d.listener = c;
                if (a.addEventListener) jd || (e = f), void 0 ===
        ...
        vd = function(a, b, c, d, e) {
            if (Array.isArray(b))
                for (var g = 0; g < b.length; g++) vd(a, b[g], c, d, e);
            else c = xd(c), a && a[ld] ? a.K.add(String(b),
                c, !0, pa(d) ? !!d.capture : !!d, e) : zd(a, b, c, !0, d, e)
        },
        Ed = function(a, b, c, d, e) {
            if (Array.isArray(b))
                for (var g = 0; g < b.length; g++) Ed(a, b[g], c, d, e);
            else d = pa(d) ? !!d.capture : !!d, c = xd(c), a && a[ld] ? a.K.remove(String(b), c, d, e) : a && (a = Ad(a)) && (b = a.ib(b, c, d, e)) && Fd(b)
        },
        Fd = function(a) {
            if ("number" !== typeof a && a && !a.Ia) {
                ...
                if (b && b[ld]) rd(b.K, a);
                    ...
                    ud--;
                    (c = Ad(b)) ? (rd(c, a), 0 == c.Na && (c.src = null, b[sd] = null)) : od(a)
                }
            }
        },
        Cd = function(a) {
    ...
    U.prototype.dispatchEvent = function(a) {
        ...
        b = this.dc;
        d = a.type || a;
        if ("string" === typeof a) a = new R(a, b);
        else if (a instanceof R) a.target = a.target || b;
        else {
            var e = a;
            a = new R(d, b);
            mb(a, e)
        ...
        a.Ha || (f = a.currentTarget = b, e = Hd(f, d, !0, a) && e, a.Ha || (e = Hd(f, d, !1, a) && e));
        if (c)
            for (g = 0; !a.Ha && g < c.length; g++) f = a.currentTarget = c[g], e = Hd(f, d,
                !1, a) && e;
        return e
    };
    U.prototype.wa = function() {
        ...
        if (this.K) {
            var a = this.K,
                ...
                c;
            for (c in a.v) {
                for (var d = a.v[c], e = 0; e < d.length; e++) ++b, od(d[e]);
                delete a.v[c];
                a.Na--
            }
        }
    ...
    */
    ...
    V.prototype.disconnect = function() {
        if (this.Z && (this.Z = null, this.j && (Qd(this.j), this.j = null), this.g.removeEventListener("message", this.Gb), this.Y)) {
            for (var a in this.Y) {
                var b = this.Y[a];
                b.port1 && Qd(b.port1);
                b.port2 && Qd(b.port2)
    ...
    var Rd = function(a) {
        ...
        Vd = function(a, b) {
            ...
            c ? (Td(a, "start", b, [c.port2]), Ud(a, c.port1)) : Td(a, "start", b)
        },
        Td = function(a, b, c, d) {
            c = {
        ...
        if (!this.vc || Rd(this) == a.source) {
            ...
            if (b && "__ACTIVITIES__" == b.sentinel) {
                ...
                if (!this.j || "connect" == c || "start" == c) {
                    ...
                    null == this.C && a.source && Rd(this) == a.source && (this.C = d);
    ...
    V.prototype.qa = function(a, b, c) {
        "connect" == a ? (this.j && (Qd(this.j), this.j = null), this.Cb = b && b.acceptsChannel || !1, this.Z(a, b)) : "start" == a ? ((c = c.ports && c.ports[0]) && Ud(this, c), this.Z(a, b)) : "msg" == a ? null != this.Xa && null != b && this.Xa(b) : "cnget" == a ? (b = b.name || "", a = Wd(this, b), a.port1 || (c = new this.g.MessageChannel, a.port1 = c.port1, a.port2 = c.port2, a.Wb(a.port1)), a.port2 && (Td(this, "cnset", {
            name: b
        }, [a.port2]), a.port2 = null)) : "cnset" == a ? (a = c.ports[0], b = Wd(this, b.name), b.port1 = a, b.Wb(a)) : this.Z(a, b)
    };
    ...
    m.qa = function(a, b) {
        "connect" == a ? (Vd(this.m, this.Pa), this.va()) : "result" == a ? this.J && (a = b.code, b = new Jd(a, "failed" == a ? Error(b.data || "") : b.data, "iframe", Sd(this.m), !0, !0), Nd(this.g, b, this.J), this.J = null, Td(this.m, "close"), this.disconnect()) : "ready" == a ? this.$a && (this.$a(), this.$a = null) : "resize" == a && (this.Vb = b.height, this.Rb && this.Rb(this.Vb))
    };
    var Yd = function(a, b, c, d, e, g) {
        var f = this,
            h = d && C(d);
    ...
    var Zd = function(a) {
            ...
            e ? (a.ba = e, "_top" != C(d) && ae(a)) : be(a, Error("failed to open window"));
    ...
    Yd.prototype.$ = function(a, b) {
        if (this.J) {
            ...
            a = new Jd(a, b, "popup", c ? Sd(this.m) : Tb(this.bb), c, c);
            Nd(this.g, a, this.J);
            this.J = null
        }
        this.m && Td(this.m, "close");
        this.disconnect()
    };
    Yd.prototype.qa = function(a, b) {
        var c = this;
        "connect" == a ? (Vd(this.m, this.Pa), this.va()) : "result" == a ? (a = b.code, this.$(a, "failed" == a ? Error(b.data || "") : b.data)) : "check" == a && this.g.setTimeout(function() {
            return ce(c)
        }, 200)
    };
    ...
    de.prototype.Oa = function() {
        var a = this,
            b = new Jd(this.ic, this.ha, "redirect", this.C, this.Cc, !1);
        return new r.Promise(function(c) {
            Nd(a.g, b, c)
        })
    };
    ...
    ee.prototype.open = function(a, b, c, d, e) {
        return {
            qd: ge(this, a, b, c, d, e).jb()
        }
    };
    var he = function(a, b, c, d, e) {
        var g = ge(a, "GPAY", b, c, d, e);
                ...
                if (e) {
                    ...
                    if (g && g.requestId == a) {
                        ...
                        var x = g.code,
                            y = g.data,
                            I = g.origin,
                            ja = d.document.referrer && Tb(d.document.referrer);
                        c = new de(d, x, y, I, I == ja)
                    } else c = null
                } else c = null
            } catch (T) {
                Pd(T), this.Tb(T)
    ...
    var ge = function(a, b, c, d, e, g) {
            var f = new Yd(a.g, b, c, d, e, g);
    ...
    W.prototype.qc = function(a) {
        ...
        this.ga(a.Oa().then(function(c) {
            if ("TIN" != b.s && c.origin != ke(b)) throw Error("channel mismatch");
            var d = c.data;
            if (d.redirectEncryptedCallbackData) return P = 3, le(b, d.redirectEncryptedCallbackData).then(function(e) {
        ...
        return new r.Promise(function(c, d) {
            if (Tc(a)) c({
                ...
                if ((0 < e.indexOf("GSA/") && 0 < e.indexOf("Safari") || g || f || h || k || l) && !b.cb) c({
                    ...
                    q && 2 <= a.apiVersion && a.existingPaymentMethodRequired ? (a.environment = b.s, Cc(a, 6, ["isReadyToPayResponse", "isReadyToPayError"], function(x) {
                        var y = {
                            result: q
                        };
    ...
    W.prototype.O = function(a) {
        if (this.cb) {
            this.ua(a);
            var b = ne(this, a),
                c = oe(this, b.container, b.iframe, a);
            this.Ga = {
    ...
    W.prototype.U = function(a) {
        ...
        if (this.cb) {
            ...
            if (this.Ga) {
                ...
                this.Ga = null
            } else c = ne(this, a), d = oe(this, c.container, c.iframe, a);
            pe(this, c.container, c.iframe, a);
            ...
            var e = function(g) {
                ...
                g.container.parentNode && (b.Jb(r.Promise.reject({
                    ...
                    qe(g.container, g.iframe), b.j && b.j.disconnect());
        ...
        } else return P = a.forceRedirect ? 3 : 2, he(this.Db, "TIN" == this.s ? "/ui/pay" : ke(this) + "/gp/p/ui/pay", a.forceRedirect ? D("_top") : D("gp-js-popup"), a, re(a)).then(function(g) {
            var f = new Fc;
            b.Mb.show(g && g.jb());
            g.onMessage(function(h) {
                "partialPaymentDataCallback" == h.type ? b.pb = Kc(h.data, b.B, b.la, f.Wa).then(function(k) {
                        return g.message(k)
                    }) :
                    "fullPaymentDataCallback" == h.type && (b.ob = Jc(h.data, b.B, b.la, f.Wa).then(function(k) {
                        g.message(k)
                    }))
            })
        })
    ...
    var ke = function(a) {
        ...
        me = function(a) {
            var b = ke(a) + "/gp/p/apis/buyflow/process";
    ...
    var pe = function(a, b, c, d) {
            ...
            setTimeout(function() {
                ...
                setTimeout(function() {
                    a.yb = !0;
                    a.Ja && (te(c, a.Ja.transition), c.height = a.Ja.height, a.Ja = null)
                }, 250)
            }, 1)
        },
        te = function(a, b) {
        ...
        oe = function(a, b, c, d) {
            ...
            var g;
            e = se(a.s, e);
            return fe(c, e, d).then(function(f) {
                a.j = f;
                var h = new Fc;
                f.onMessage(function(k) {
                    "partialPaymentDataCallback" == k.type ? a.pb = Kc(k.data, a.B, a.la, h.Wa).then(function(l) {
                        return f.message(l)
                    }) : "fullPaymentDataCallback" == k.type ? a.ob = Jc(k.data, a.B, a.la, h.Wa).then(function(l) {
                        return f.message(l)
                    }) : "resize" == k.type && (a.yb ? (g || (g = Date.now()), Date.now() < g + 250 ? te(c, k.transition + ", height 250ms") : te(c, k.transition), c.height = k.height) : a.Ja = {
                        height: k.height,
    ...
    var ue = "actions.google.com amp-actions.sandbox.google.com amp-actions-staging.sandbox.google.com amp-actions-autopush.sandbox.google.com payments.developers.google.com payments.google.com".split(" "),
        Y = function(a, b, c, d) {
            this.lb = b;
            Xc(a);
            this.Pb = null;
            this.s = a.environment || "TEST";
            ve || (ve = -1 != ue.indexOf(window.location.hostname) && a.i && a.i.googleTransactionId ? a.i.googleTransactionId : Ta(this.s));
            this.H = a;
            ...
            this.X = null;
            b = this.l.mode;
            this.pa = 5 === b || 4 === b ? new Pc(this.s) : this.ea;
            ...
            window.addEventListener("message", function(e) {
                -1 != ue.indexOf(window.location.hostname) && "logPaymentData" === e.data.name && Q(e.data.data)
            })
        },
        ve, X = function(a) {
    ...
    var ze = function(a, b, c, d, e) {
        ...
        xe = function(a, b, c) {
            if (google.payments.api.DisableNativeReadyToPayCheckForPaymentHandler ? 4 ===
                a.l.mode && !Be(b) : a.l.La && !Be(b)) {
                if (2 <= b.apiVersion) return Ce(a, b, c);
                var d = a.ea.F(b),
                    e = a.pa.F(b);
                if (Tc(b) && !a.l.ta) return c.push(6), e;
                c.push(7);
        ...
        Ce = function(a, b, c) {
            ...
            var f = d;
            Vc(b, "PAN_ONLY") && (c.push(9), f = a.ea.F(b));
    ...
    m.O = function(a) {
        ...
        b ? E({
            ...
            errorMessage: b
        }) : (this.ua(a), this.l.La && !Be(a) ? this.pa.O(a) : this.ea.O(a))
    };
    m.Da = function() {};
    m.U = function(a) {
        var b = this,
    ...
    m.oa = function(a) {
        ...
        b = a;
        c = c && t(oc, "includes").call(oc, Wa(c));
        d = t(mc, "includes").call(mc, Wa(lc));
        var e = t(nc, "includes").call(nc, Wa(lc));
    ...
    var ye = null,
        ...
        De = function(a, b, c) {
            return 2 === a.mode || 1 === a.mode ? a.mode : Be(b) ? (c.push(3), 2) : !Ee && (a.ta || google.payments.api.UseCanMakePaymentForFallbackOnMobile && a.La) ? (c.push(40), 2) : a.ta && b.swg ? (c.push(5), 2) : a.mode
        },
        Fe = function(a) {
    ...
    Z.prototype.createButton = Z.prototype.oa;
    Z.prototype.notifyAvailableOffers = Z.prototype.Da;
    google.payments.api.UseCanMakePaymentResultFromPayjs && (ye = (new PaymentRequest([{
        supportedMethods: ["https://google.com/pay"],
        data: {
            apiVersion: 2,
            apiVersionMinor: 0,
    ...
    })).canMakePayment(), ye.then(function(a) {
        return Ee = a
    }).catch(function() {
        return Ee = !1
    }));
